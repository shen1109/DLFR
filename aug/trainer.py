...
class train():
    ...
    def pretrain(
        ...
        with tqdm(total=int(self.pre_epochs), 
                    desc="a trains an initial model",
    ...
    def fit(self, 
        ...
        with tqdm(total=int(self.pre_epochs), 
            ...
            for epoch in range(self.epochs):
                ...
                if self.domains is None:
                    loss = self.kl_weight * loss_kl + loss_A
                else:
                    loss = self.kl_weight * loss_kl + loss_A + domain_loss
                loss.backward()
